    ...
    {[
      ...
      >
        ...
        <section className="mb-48 text-center">
          ...
          <Link to = "typingtext"> 
          <button className="bg-[#10B981] text-black font-bold py-3 px-6 rounded-lg hover:bg-[#0D9668]  hover:border-none transition duration-300">
...
<div class="rounded-xl border text-card-foreground shadow bg-neutral-900/50 border-neutral-800 h-full max-w-xs">
  <div class="flex flex-col space-y-1.5 p-6">
    <div class="font-semibold tracking-tight flex items-center space-x-4 text-neutral-200 text-2xl">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-activity size-10 text-emerald-400">
        <path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"></path></svg><span>Real-time Feedback</span></div></div><div class="p-6 pt-0">
    <div class="text-neutral-400 text-base">Get instant feedback of your typing speed, and accuracy.
    </div>
  </div>
</div>
